...
// ▼ モリアーティモード専用のエピソードデータ
const MORIARTY_ACTS = [
  {
    title: "第1幕：方程式の証明",
    episodes: [
      { id: "M-01", title: "因果律の証明", summary: "アメリカから来た御者の復讐を支援し、ホームズという「有能な観測者」を認知する。" },
      { id: "M-02", title: "密室の物理学", summary: "暴君ロイロット博士に対し、毒蛇と探偵の介入を用いた「自滅の因果律」を設計する。" },
      { id: "M-03", title: "不純物の除去", summary: "ロンドンに進出しようとする海外マフィアを、探偵とヤードの力を使って一網打尽にさせる。" }
    ]
  },
  {
    title: "第2幕：盤面の支配",
    episodes: [
      { id: "M-04", title: "美しきノイズ", summary: "アイリーンという計算外の変数によるノイズを、美学（AESTHETIC）としてあえて許容する。" },
      { id: "M-05", title: "欲望の確率論", summary: "名馬を巡る強欲な調教師を、オッズ操作と借金という「確率論」の罠にかけて自滅させる。" },
      { id: "M-06", title: "経済の血液", summary: "架空の就職話で時間と空間を計算し、大英帝国の経済の中枢（マウソン商会）をハッキングする。" }
    ]
  },
  {
    title: "第3幕：グランドフィナーレ",
    episodes: [
      { id: "M-07", title: "虚構のトンネル", summary: "赤毛組合という滑稽な謎解きで警察の目を逸らし、その裏で真の要人を暗殺する。" },
      { id: "M-08", title: "盤面の浄化", summary: "肥大化した自らの犯罪インフラを解体するため、探偵に意図的に証拠をリークする。" },
      { id: "M-09", title: "究極の方程式", summary: "ライヘンバッハの滝。絶対的な「光」を伝説へと昇華させるための、最後のチェックメイト。" }
    ]
  }
];
